  ...
  return (
    <CustomNavbar
      ...
      elems_right={[
        ...
        {name: 'Mi cuenta', href: '', popup: [{name: 'Ver mi perfil', href: '/providers/seller/profile'}, {name: 'Cambiar contraseña', href: '/providers/seller/change_password'}, {name: 'Cerrar sesión', href:'#', signoutComponent: '/auth/login'}]},
      ]}
    />
  )
}