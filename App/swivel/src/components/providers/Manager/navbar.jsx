  ...
  return (
    <CustomNavbar
      ...
      elems_right={[
        ...
        {name: 'Mi cuenta', href: '', popup: [{name: 'Ver mi perfil', href: '/providers/manager/profile'}, {name: 'Cambiar contraseña', href: '/providers/manager/change_password'}, {name: 'Cerrar sesión', href:'#', signoutComponent: '/auth/login'}]},
      ]}
    />
  )
}