  ...
  return (
    <CustomNavbar
      ...
      elems_right={[
        ...
        {name: 'Mi cuenta', href: '', popup: [{name: 'Mi perfil', href: ''}, {name: 'Cambiar contraseña', href: '/providers/manager/change_password'}, {name: 'Cerrar sesión', href:'#', signoutComponent: '/auth/providers/login'}]},
      ]}
    />
  )
}