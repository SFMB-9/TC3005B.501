          ...
          <div className="d-flex flex-column justify-content-center align-items-center">
            ...
            <b className="text-center mt-3 mb-3 fs-2 align-items-stretch">
              <Typography wrap="true" variant="h1" sx={{
                ...
                fontSize: '2rem',
                fontFamily: 'Raleway',
              }}> Registra a tu Grupo </Typography></b>
          </div>
          <form className="d-flex flex-column ">
            <div className="form-outline mb-2">
                <input type="text" className="form-control" placeholder="Nombre del Grupo Automotriz"/>
            </div>
            <div class="form-outline mb-2">
              <input type="email" className="form-control" placeholder="Correo Electrónico"/>
            </div>
            <div className="form-outline mb-2">
              <input type="tel" className="form-control" placeholder="Num Telefónico"/>
            </div>
            <div className="form-outline mb-2">
