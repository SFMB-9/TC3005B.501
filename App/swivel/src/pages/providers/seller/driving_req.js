...
const SellerDashboard = () => {
    ...
    const columns = [ 
      ...
      { 
        ...
        minWidth: 150,
        flex: 1,
        valueFormatter: (params) => new Date(params.value).toLocaleDateString('es-ES', { year: 'numeric', month: 'numeric', day: 'numeric' }),
      },
      { 
        field: 'horario',
        headerName: 'Horario',
        ...
        minWidth: 150,
        flex: 1,
        valueGetter: (params) => new Date(params.row.fecha_agendada).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' }),
      },
      {
        field: 'status',
        headerName: 'Estatus',
            ...
            <div className='section'>
              <div className='text-center pt-3'>
                <SimpleToggleButton
                  ...
                  sx = {{
                    "& .MuiToggleButtonGroup-grouped": { minWidth: '100px', fontFamily: 'Lato', color: '#333333', },
                  }}
                />
              </div>
            </div>
