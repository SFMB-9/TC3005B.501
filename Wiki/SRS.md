...
| **Post-condiciones:** | 1. El usuario tiene una cuenta en la plataforma. 2. El usuario puede utilizar su cuenta correctamente. |
| **Flujo:** | 1. El usuario entra en el sitio y es recibido por la página de inicio. 2. El usuario pulsa el botón "Registrarse". 3. Se pide al usuario que elija entre iniciar sesión en Google o crear una cuenta, y elige crear una cuenta. 4. El usuario introduce un correo electrónico y la información correspondiente necesaria para crear una cuenta, como nombre completo, fecha de nacimiento, número de teléfono y una contraseña segura. 5. Se pide al usuario que introduzca los documentos legales necesarios para verificar su identidad. 6. El usuario pulsa el botón "Aceptar" y se le pide que acepte los términos y condiciones. 7. El usuario pulsa el botón "Aceptar condiciones". 8. El front-end envía la información y los ficheros al SGBD para que los inserte en la base de datos. 9. El SGBD crea una consulta para hacer una nueva entrada en la tabla "Cliente". 10. EL SGBD devuelve una respuesta correcta al front-end. 11. El usuario es redirigido a su página de inicio personal. |
| **Flujos alternativos:** | 3. En el paso 3 del flujo normal, el usuario puede optar por hacer uso de un inicio de sesión con una cuenta de Google. 1. Se pide al usuario que inicie sesión a través de Google. 2. El usuario introduce su cuenta de Google correspondiente e inicia sesión. 3. El usuario introduce la información necesaria para crear su cuenta, como nombre completo, fecha de nacimiento, número de teléfono y una contraseña segura. 4. Se pide al usuario que introduzca los documentos legales necesarios para verificar su identidad. 5. El usuario pulsa el botón "Aceptar" y se le pide que acepte los términos y condiciones. 6. El usuario pulsa el botón "Aceptar condiciones". 7. El front-end envía la información y los ficheros al SGBD para que los inserte en la base de datos. 8. El SGBD crea una consulta para hacer una nueva entrada en la tabla "Cliente". 9. El SGBD devuelve una respuesta correcta al front-end. 10. El usuario es redirigido a su página de inicio personal. 5. En el paso 5 del flujo normal, así como en el paso 4 del flujo alternativo anterior, el usuario puede optar por omitir la adición de documentos en ese momento. 1. El usuario pulsa el botón "Aceptar" y se le pide que acepte los términos y condiciones. 2. El usuario pulsa el botón "Aceptar condiciones". 3. El front-end envía la información y los ficheros al SGBD para que los inserte en la base de datos. 4. El SGBD crea una consulta para hacer una nueva entrada en la tabla "Cliente". 5. El SGBD devuelve una respuesta correcta al front-end. 6. El usuario es redirigido a su página de inicio personal.7. En el paso 7 del flujo normal, así como en los pasos 5 del primer flujo alternativo, el usuario puede rechazar los términos y condiciones.1. Se cierra la consulta correspondiente y se redirige al usuario a la página de inicio. |
